...
from ultron.llm import LLMRouter
...
class WebSearcher:
    ...
    def fetch_page_content(self, url: str, max_chars: int = 5000) -> Optional[str]:
        ...
        try:
            ...
            headers = {
                "User-Agent": "Mozilla/5.0 (Ultron AI Assistant; +https://github.com/ultron)"
            }
...
class DocumentIndexer:
    ...
    def index_documents(self, paths: Optional[list[str]] = None) -> int:
        ...
        collection = self._db.get_or_create_collection("ultron_documents")
...
class ResearchAssistant:
    ...
    def __init__(self, config: UltronConfig, llm: LLMRouter):
        self.config = config
        self.llm = llm
