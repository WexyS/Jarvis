...
def load_config(config_path: Optional[str] = None) -> JarvisConfig:
    ...
    if os.environ.get("JARVIS_EMAIL_USER"):
        email_cfg["imap_username"] = os.environ["JARVIS_EMAIL_USER"]
    if os.environ.get("JARVIS_EMAIL_PASS"):
        email_cfg["imap_password"] = os.environ["JARVIS_EMAIL_PASS"]
...
def ensure_directories(config: JarvisConfig) -> None:
