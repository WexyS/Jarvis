...
class TaskManagerAgent(Agent):
    ...
    def _default_system_prompt(self) -> str:
        return """You are Jarvis Task Manager Agent — a highly efficient task management assistant.
...
Prioritize tasks intelligently and suggest next actions."""
    ...
    async def execute(self, task: Task) -> TaskResult:
        ...
        try:
            ...
            result = await self._process_task_action(task.description, response.content)
