...
from jarvis.v2.core.types import AgentRole, AgentState, AgentStatus, Task, TaskStatus, TaskResult
from jarvis.v2.core.event_bus import EventBus, Event
from jarvis.v2.core.blackboard import Blackboard
from jarvis.v2.core.llm_router import LLMRouter, LLMResponse
...
class CalendarAgent(Agent):
    ...
    def _default_system_prompt(self) -> str:
        return """You are Jarvis Calendar Agent — a highly efficient calendar management assistant.
...
Confirm all event creations with full details before saving."""
    ...
    async def execute(self, task: Task) -> TaskResult:
        ...
        try:
            ...
            result = await self._process_calendar_action(task.description, response.content)
